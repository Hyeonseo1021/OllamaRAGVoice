...
def classify_question_type(prompt: str) -> str:
    ...
    ** 분류 기준 **
    ...
    - UNKNOWN : 스마트팜과 관련 없는 일반적인 문장, 의미 없는 문장, 문서에 존재하지 않는 정보를 요청하는 경우
    ...
    사용자의 질문을 위 규칙에 따라 분류하세요. **응답은 반드시 'DATA', 'RAG', 'BOTH', 'UNKNOWN' 중 하나로만 하십시오.**
    """
    ...
    if hasattr(response, "message") and hasattr(response.message, "content"):
        ...
        for category in ["DATA", "RAG", "BOTH", "UNKNOWN"]:
